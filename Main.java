...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            System.out.print("Choose your 1st service (cut): ");
            String service1 = sc.nextLine();

            System.out.print("Choose your 2nd service (shave): ");
            String service2 = sc.nextLine();

            System.out.print("Choose your 3rd service (haircolor): ");
            ...
            if (service1.equals("cut") && service2.equals("shave") && service3.equals("haircolor")) {
                ...
                tc.FirstChoice(false, false, true);
            } else {
